...
<div id="register-content"> 
	...
	<form action="assets/inc/process.inc.php" method="post">         
		<fieldset><legend>&nbsp;</legend>
			...
			<input type="password" name="pword" id="pword" value="" placeholder="Password" required/> 
			<label for="confirm_pword">Confirm</label>             
			<input type="password" name="confirm_pword" id="confirm_pword" value="" placeholder="Confirm Password" required/>  
			<label for="user_email">Email</label>             
			<input type="text" name="email" id="user_email" value="" placeholder="Email" required/>  
			<label for="birthdate">Birthdate</label>
			 <input id="birthdate" type="date" placeholder="Enter Birth Date (mm/dd/yyyy)" name="birthdate" value=""> 
